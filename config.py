...
CHALLENGES = [
    {
        "id": "stability_drill",
        "group": "Stability",
        "name": "Lockbreak Drill",
        "desc": "Trigger 3 manual collapses during this instability trial to prove you can break the lock on command.",
    ...
    },
    {
        ...
        "group": "Stability",
        "name": "Spark Hijack",
        "desc": "Earn 1,000 Stability Sparks after starting the trial to siphon a reserve for future escapes.",
